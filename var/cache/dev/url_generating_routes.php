...
return [
    ...
    'app_movies_show' => [['id'], ['_controller' => 'App\\Controller\\MoviesController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/movies']], [], [], []],
    'movie_delete' => [['id'], ['_controller' => 'App\\Controller\\MoviesController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/movies/delete']], [], [], []],
    ...
    'app_singup' => [[], ['_controller' => 'App\\Controller\\SingupController::index'], [], [['text', '/singup']], [], [], []],
];
